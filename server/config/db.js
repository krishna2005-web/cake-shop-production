...
// Uses MongoDB Memory Server as fallback when
// local MongoDB is not available
// ===========================================
...
// Seed the database with cake data when using in-memory mode
async function seedDatabase() {
  const Cake = require('../models/Cake');
  const count = await Cake.countDocuments();
  if (count > 0) return;

  console.log('🌱 Auto-seeding database with cake data...');
  ...
  const cakes = [
    {
      ...
      rating: 4.8, reviews: 142, featured: true,
    ...
    },
    {
      ...
      rating: 4.9, reviews: 208, featured: true,
    ...
    },
    {
      ...
      rating: 4.7, reviews: 95, featured: true,
    ...
    },
    {
      ...
      rating: 4.5, reviews: 176, featured: false,
    ...
    },
    {
      ...
      rating: 4.6, reviews: 134, featured: true,
    ...
    },
    {
      ...
      rating: 4.8, reviews: 89, featured: false,
    ...
    },
    {
      ...
      rating: 4.5, reviews: 72, featured: false,
    ...
    },
    {
      ...
      rating: 4.7, reviews: 98, featured: true,
    ...
    },
    {
      ...
      rating: 4.6, reviews: 156, featured: false,
    ...
    },
    {
      ...
      rating: 4.9, reviews: 112, featured: true,
    ...
    },
    {
      ...
      rating: 4.7, reviews: 188, featured: false,
    ...
    },
    {
      ...
      rating: 4.6, reviews: 64, featured: false,
    ...
    },
    {
      ...
      rating: 4.5, reviews: 203, featured: false,
    ...
    },
    {
      ...
      rating: 4.7, reviews: 131, featured: false,
    ...
    },
    {
      ...
      rating: 4.8, reviews: 54, featured: false,
      tags: ['wedding', 'rustic', 'naked', 'natural'],
    },
  ];

  await Cake.insertMany(cakes);
  console.log(`🎂 Auto-seeded ${cakes.length} cakes!`);
}
